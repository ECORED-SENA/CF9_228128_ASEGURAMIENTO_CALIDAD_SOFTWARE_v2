...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      .col-lg-2.col-4.mb-lg-0.mb-3: img(src='@/assets/curso/temas/59.svg', alt='')
      .col-lg-5.mb-lg-0.mb-3
        .cajon-b.color-primario.p-3.mb-5
          p.mb-0 Para explicar este tipo de ejercicios, crearemos una base de datos de empleados llamada #[strong "ehr"], y las tablas #[strong "empleados"] y #[strong "areas"], se relacionan así: un empleado pertenece a un área y un área puede tener varios empleados.
      .col-lg-5: img(src='@/assets/curso/temas/60.png', alt='')

    .row.justify-content-center.mb-5
      .col-lg-6.mb-lg-0.mb-3
        p.mb-5(data-aos='fade-right') Note que #[b "area_id"] en la tabla #[strong "empleados"] puede ser nuleable: 
    ...
    p.mb-5(data-aos='fade-right') Con esta operación, cada fila en la tabla #[b "empleados"] es combinada (o unida) con los correspondientes de la tabla #[b "areas"] que satisface la condición que se especifiquen en el predicado del #[em #[b JOIN.]] Cualquier fila de la tabla #[b "empleados"] o de la tabla #[strong "areas"] que no tenga uno correspondiente en la otra tabla (#[strong "areas"]) es excluido y solo aparecerán los que tengan correspondencia en la otra tabla. Este es el tipo de #[em #[b JOIN ]]más utilizado, por lo que es considerado el tipo de combinación predeterminado.
    .row.justify-content-center.mb-5
    ...
    .row.justify-content-center.mb-5
      .col-lg-10
        .tarjeta.p-4(style="background-color: #bae9d9 ")
          p.mb-0(data-aos='fade-right') La condición de la relación #[em #[b (a.id_area= e.area_id)]] consiste en que debe estar presente en ambas tablas el valor. Cuando el empleado tiene #[em #[b NULL]] en #[strong "area_id"] no aparece, debido a que no puede cumplirla. Esto se representa con un diagrama de Venn en la conjunción, porque el valor debe estar en ambas tablas. 
    .row.justify-content-center.mb-5
    ...
    .fondo-t4.mn.p-5
      .row.justify-content-center.mb-5
        .col-lg-5.mb-lg-0.mb-3
          .tarjeta.color-secundario.p-5.h-100 
              .tarjeta.color-acento-contenido.p-3.d-inline-block.rounded-3.mb-4
                h4.mb-0.fst-italic LEFT JOIN
              p La sintaxis es muy similar a la anterior.  
                br
                br
                |#[b.text-color-acento-contenido SELECT * ] 
                br
                |#[b.text-color-acento-contenido FROM empleados AS e ]
                br
                |#[b.text-color-acento-contenido LEFT JOIN areas as a ON a.id_area = e.area_id ]
        ...
        .col-lg-5.mb-lg-0.mb-3
          .tarjeta.p-4(style="background-color: #bae9d9 ").h-100
            img(src='@/assets/curso/temas/70.svg', alt='').m-auto
            p La sentencia #[b #[em LEFT JOIN]] devuelve la pareja de todos los valores de la tabla izquierda (empleados), con los valores de la tabla de la derecha (#[strong "areas"]) correspondientes, si los hay, o retorna un valor nulo #[b #[em NULL] ] en los campos de la tabla derecha cuando no haya correspondencia.
      p.mb-5(data-aos='fade-right') A diferencia del resultado presentado en el ejemplo #[em #[b INNER JOIN]] donde no se mostraba el empleado cuya área no existía, en el ejemplo siguiente se presentarán los empleados con su respectiva área, y adicionalmente se presentará un empleado cuya área no existe. 
        br
        br
      ...
      .row.justify-content-center.mb-5
        .col-lg-5.mb-lg-0.mb-3
          .tarjeta.color-secundario.p-5.h-100 
              .tarjeta.color-acento-contenido.p-3.d-inline-block.rounded-3.mb-4
                h4.mb-0.fst-italic RIGTH JOIN 
              p La sentencia #[em #[b RIGHT JOIN]] retorna todos los valores de la tabla derecha (#[strong "areas"]) con los valores de la tabla de la izquierda (empleados) correspondientes, si existen, o retorna un valor nulo #[em #[b NULL]] para los campos de la tabla izquierda cuando no haya correspondencia. 
                br
                br
                | #[b.text-color-acento-contenido SELECT * ]
                br 
